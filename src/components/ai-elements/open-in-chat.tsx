...
import { ArrowDown01Icon, LinkSquare01Icon, MessageCircleIcon } from "@hugeicons/core-free-icons";
...
const providers = {
  ...
  t3: {
    ...
    icon: <HugeiconsIcon icon={MessageCircleIcon} />,
  },
  v0: {
    title: "Open in v0",
    createUrl: (q: string) =>
  ...
  return (
    <DropdownMenuItem asChild {...props}>
      ...
      >
        ...
        <HugeiconsIcon icon={LinkSquare01Icon} className="size-4 shrink-0" />
      </a>
    </DropdownMenuItem>
  );
};
