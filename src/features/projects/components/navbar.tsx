...
import { CloudSavingDone02Icon, Loading01Icon } from "hugeicons-react";
    ...
    <nav className="flex justify-between items-center gap-x-2 p-2 bg-sidebar border-b">
      <div className="flex items-center gap-x-2">
        <Breadcrumb>
          <BreadcrumbList className="gap-0!">
            <BreadcrumbItem>
              <BreadcrumbLink
                render={<Link href="/" />}
                className="inline-flex items-center gap-1.5 rounded p-1.5 h-7 hover:bg-accent"
              >
                <Image
                  src="/zelda-logo.webp"
                  alt="Logo"
        ...
        {project?.importStatus === "importing" ? (
          ...
          <Tooltip>
            <TooltipTrigger>
              <CloudSavingDone02Icon className="size-4 text-muted-foreground" />
            </TooltipTrigger>
            <TooltipContent>
              Saved{" "}
              {project?.updatedAt
